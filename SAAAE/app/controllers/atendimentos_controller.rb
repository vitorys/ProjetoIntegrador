class AtendimentosController < ApplicationController
  ...
  def index
    @atendimentos = Atendimento.all.page(params[:page]).per(15)
  end
  ...
  def destroy
    @atendimento.destroy
    respond_to do |format|
      format.html { redirect_to request.referrer, notice: 'Atendimento deletado com sucesso.' }
  ...
  private
    ...
    def atendimento_params
      params.require(:atendimento).permit(:aluno_id, :area, :funcionario_id,:telefone)
    end
end
