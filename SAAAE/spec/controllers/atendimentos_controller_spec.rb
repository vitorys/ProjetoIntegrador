...
RSpec.describe AtendimentosController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      atendimento = Atendimento.create! valid_attributes
      get :show, params: {id: atendimento.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      atendimento = Atendimento.create! valid_attributes
      get :edit, params: {id: atendimento.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Atendimento" do
        expect {
          post :create, params: {atendimento: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {atendimento: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested atendimento" do
        atendimento = Atendimento.create! valid_attributes
        put :update, params: {id: atendimento.to_param, atendimento: new_attributes}, session: valid_session
        atendimento.reload
      ...
      it "redirects to the atendimento" do
        atendimento = Atendimento.create! valid_attributes
        put :update, params: {id: atendimento.to_param, atendimento: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        atendimento = Atendimento.create! valid_attributes
        put :update, params: {id: atendimento.to_param, atendimento: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested atendimento" do
      atendimento = Atendimento.create! valid_attributes
      expect {
        delete :destroy, params: {id: atendimento.to_param}, session: valid_session
      }.to change(Atendimento, :count).by(-1)
    end
