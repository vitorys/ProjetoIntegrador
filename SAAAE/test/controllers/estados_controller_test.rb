...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { estado_nome: @estado.estado_nome, estado_uf: @estado.estado_uf } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { estado_nome: @estado.estado_nome, estado_uf: @estado.estado_uf } }
