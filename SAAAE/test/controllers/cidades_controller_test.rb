...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { cidade_estado: @cidade.cidade_estado, cidade_nome: @cidade.cidade_nome } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { cidade_estado: @cidade.cidade_estado, cidade_nome: @cidade.cidade_nome } }
